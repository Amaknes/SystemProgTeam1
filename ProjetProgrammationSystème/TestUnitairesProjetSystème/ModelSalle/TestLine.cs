...
namespace TestUnitairesProjetSystème.ModelSalle
{
    ...
    public class TestLine
    {
        ...
        public void TestGetIdLine()
        {
            ...
            Assert.AreEqual(testLine1.IdLine, 1);
        }
        ...
        public void TestSetIdLine()
        {
            Line testLine1 = new Line(1);
            testLine1.IdLine = 2;
            Assert.AreEqual(testLine1.IdLine, 2);
        }
        ...
        {
            Line testLine1 = new Line(1);
            Assert.AreEqual(testLine1.ListTable.Count, 7);
        }
        ...
        public void TestSetListTable()
        {
            ...
            Assert.AreEqual(testLine1.ListTable, tableList);
        }
    }
}
